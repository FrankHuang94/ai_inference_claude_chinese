...
| 02 | [02_mobile_npu_soc_and_memory_constraints.md](02_mobile_npu_soc_and_memory_constraints.md) | 移动 SoC、NPU 与内存约束 | 已完成 |
| 03 | `03_qualcomm_apple_mediatek_google_samsung_platforms.md` | 主要移动平台的端侧推理能力 | **受阻**（内容本体为需核验的厂商规格，出口策略下无法撰写） |
| 04 | [04_pc_ai_inference.md](04_pc_ai_inference.md) | AI PC 的推理路径 | 已完成 |
| 05 | [05_automotive_robotics_and_embedded_inference.md](05_automotive_robotics_and_embedded_inference.md) | 车载、机器人与嵌入式推理 | 已完成 |
