...
> 状态：**进行中（3/12 篇）**
> 模块目标字数：**≥ 12,000 字**（当前正文约 23,000 字，已达标）
> 最后更新：2026-08-10
...
- [ ] 全部 12 篇规划文档完成（当前 **3/12**）
- [x] 模块正文合计 ≥ 12,000 字（当前约 23,000 字）
- [ ] 写作要求第 1 条：12 个卡片字段逐项覆盖——**其中「实验设置」与「关键结果」永久标注 `待核实`**，
      理由见上方降级说明；其余 10 项已在第 02、03 章逐条落实
- [x] 写作要求第 3 条：本次 session 完成 14 张卡片（P-001~P-004、P-006~P-015），在 8–15 篇区间内
- [x] 写作要求第 4 条：[`data/papers.csv`](../../data/papers.csv) 与
      [`data/references.bib`](../../data/references.bib) 已双向同步（15 条 ↔ 15 条）
