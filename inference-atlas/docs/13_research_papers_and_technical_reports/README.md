...
| 08 | [08_hardware_and_architecture_papers.md](08_hardware_and_architecture_papers.md) | 硬件与体系结构论文 | 已完成 |
| 09 | [09_networking_and_datacenter_papers.md](09_networking_and_datacenter_papers.md) | 网络与数据中心论文 | 已完成 |
| 10 | [10_edge_inference_papers.md](10_edge_inference_papers.md) | 边缘推理论文 | 已完成 |
| 11 | [11_reliability_and_benchmarking_papers.md](11_reliability_and_benchmarking_papers.md) | 可靠性与基准测试论文 | 已完成 |
| 12 | [12_recent_reading_tracker.md](12_recent_reading_tracker.md) | 近期阅读追踪 | 已完成 |
...
- [x] 全部 12 篇规划文档完成（**12/12**）
- [x] 模块正文合计 ≥ 12,000 字（实际约 79,000 字）
- [ ] 写作要求第 1 条：12 个卡片字段逐项覆盖——**其中「实验设置」与「关键结果」永久标注 `待核实`**，
      理由见上方降级说明；其余 10 项已在第 02–11 章逐条落实
- [x] 写作要求第 3 条：每 session 均在 8–15 张区间内（第 1 批 14 张：P-001~P-004、P-006~P-015；第 2 批 14 张：P-005、P-016~P-028；第 3 批 11 张：P-029~P-039；第 4 批 10 张：P-040~P-049；第 5 批 10 张：P-050~P-059）
- [x] 写作要求第 4 条：[`data/papers.csv`](../../data/papers.csv) 与
      [`data/references.bib`](../../data/references.bib) 已双向同步（59 条 ↔ 59 条）
...
- [ ] 写作要求第 2 条中的 **agent inference** 与 **reasoning test-time compute** 未建卡——
      非受阻，而是本次 session 的卡片预算已用尽（每 session 上限 8–15 张）；
      缺口与下一批的建议起点已逐条记入 [第 12 章 §3.2](12_recent_reading_tracker.md)
