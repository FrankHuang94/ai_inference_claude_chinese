...
| 06 | [06 跨硬件可移植性](06_onnx_runtime_openvino_and_portability.md) | 跨硬件可移植性与代价 | 已完成 |
| 07 | [07 算子融合与 kernel 优化](07_kernel_fusion_and_operator_optimization.md) | 算子融合与 kernel 优化基本功 | 已完成 |
| 08 | [08 FlashAttention](08_flashattention_and_memory_efficient_attention.md) | IO-aware attention 与显存/带宽优化 | 已完成 |
| 09 | [09 量化 kernel](09_quantization_kernels.md) | 量化 GEMM 与低精度 kernel 实现 | 已完成 |
| 10 | [10 CUDA Graphs](10_cuda_graphs_and_execution_overhead.md) | launch overhead 与 CUDA Graphs | 已完成 |
| 11 | [11 编译调试与 profiling](11_compiler_debugging_and_profiling.md) | 编译与 kernel 层的调试与 profiling | 已完成 |
