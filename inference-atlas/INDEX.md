...
| 文档 | 一句话说明 |
|---|---|
| `01_inference_software_stack.md` | framework → IR → compiler → runtime → kernel → driver 全栈 |
| `02_graph_compilers_and_ir.md` | 图捕获、IR 设计与图优化 |
| `03_tensorrt_llm.md` | TensorRT-LLM 的架构、优化与适用边界 |
| `04_torch_compile_inductor_and_triton.md` | TorchDynamo/Inductor/Triton 的推理路径 |
| `05_xla_jax_and_tpu_runtime.md` | XLA/JAX 与 TPU runtime |
...
| 文档 | 一句话说明 |
|---|---|
| `01_ai_datacenter_overview.md` | AI 数据中心与传统数据中心的差异 |
| `02_rack_power_and_density.md` | 机架功率密度与扩容速度 |
| `03_power_delivery_48v_and_busbar.md` | 48V 供电、busbar 与配电链路 |
| `04_cooling_air_direct_liquid_and_immersion.md` | 风冷、冷板液冷与浸没式散热 |
...
| `06_small_language_models_and_on_device_agents.md` | 小模型与端侧 agent |
| `07_quantization_distillation_and_pruning_for_edge.md` | 面向端侧的模型压缩 |
...
| `07_observability_metrics_logs_traces.md` | 指标、日志与 trace 体系 |
| `08_slos_slas_and_error_budgets.md` | SLO/SLA 与错误预算 |
...
| 文档 | 一句话说明 |
|---|---|
| `01_paper_map.md` | 论文全景地图与阅读顺序 |
| `02_transformer_inference_and_kv_cache_papers.md` | Transformer 推理与 KV cache 论文卡片 |
| `03_batching_serving_and_scheduler_papers.md` | batching、serving 与调度器论文 |
...
| `09_networking_and_datacenter_papers.md` | 网络与数据中心论文 |
